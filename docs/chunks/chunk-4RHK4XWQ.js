...
function getColors({ prng, options }) {
  var _a, _b, _c, _d, _e, _f, _g;
  return {
    accessories: convertColor2(prng.pick((_a = options.accessoriesColor) !== null && _a !== void 0 ? _a : [], "transparent")),
    clothes: convertColor2(prng.pick((_b = options.clothesColor) !== null && _b !== void 0 ? _b : [], "transparent")),
    hat: convertColor2(prng.pick((_c = options.hatColor) !== null && _c !== void 0 ? _c : [], "transparent")),
    hair: convertColor2(prng.pick((_d = options.hairColor) !== null && _d !== void 0 ? _d : [], "transparent")),
    skin: convertColor2(prng.pick((_e = options.skinColor) !== null && _e !== void 0 ? _e : [], "transparent")),
    facialHair: convertColor2(prng.pick((_f = options.facialHairColor) !== null && _f !== void 0 ? _f : [], "transparent")),
    background: convertColor2(prng.pick((_g = options.backgroundColor) !== null && _g !== void 0 ? _g : [], "transparent"))
  };
}
...
function getSvgAvatar(seed) {
  return createAvatar(lib_exports, {
    radius: 50,
    randomizeIds: false,
    seed: [String(seed)]
  }).toString();
